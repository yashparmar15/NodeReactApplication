...
const UserProfilePage = (props) => {
  ...
  },[props.user.username, props.user.picture, props.user.email]);
  //   if (!props.user) {
  //     props.history.push('/');
  //   }
  return (
    ...
    <div className="col-lg-4 order-lg-1 text-center">
        ...
        <img src={userdata.picture} className="mx-auto img-fluid img-circle d-block profile-pic-yash" alt="avatar"/>
        ...
        <a href="/" className="icon" title="Change Image">
            ...
            <p className="mt-2 card-text"> For what reason would it be advisable for me to think about business content? </p> <button className="btn btn-info btn-sm mt-8 mb-4">Follow</button>
        ...
        <div className="col-lg-8 order-lg-2">
            <ul className="nav nav-tabs">
                <li className="nav-item">
                    <div  data-target="#profile" data-toggle="tab" className="nav-link active profile-nav">Profile</div>
                </li>
                <li className="nav-item">
                    <div data-target="#messages" data-toggle="tab" className="nav-link profile-nav">Messages</div>
                </li>
                <li className="nav-item">
                    <div data-target="#edit" data-toggle="tab" className="nav-link profile-nav">Edit</div>
                </li>
            </ul>
                ...
                <div className="tab-pane active" id="profile">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <span className="badge badge-primary yf"><i className="fa fa-user"></i> 900 Followers</span>
                            <span className="badge badge-success yf"><i className="fa fa-user"></i> 43 Following</span>
                            <span className="badge badge-danger yf"><i className="fa fa-eye"></i> 245 Views</span>
                        </div>
                        <div className="col-md-12">
                            <h5 className="mt-2"><i className="fa fa-clock ion-clock float-right"></i> Recent Activity</h5>
