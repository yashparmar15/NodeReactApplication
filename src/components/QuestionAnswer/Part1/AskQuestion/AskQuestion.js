...
class AskQuestion extends Component {
  constructor(props) {
    ...
    this.onChange = (editorState) =>
      this.setState({ editorState }, console.log('editor', editorState));
      ...
      return (
        <div key={tag} className='tag-add'>
          ...
          <i
            ...
            aria-hidden='true'
            onClick={this.remove.bind(this, tag)}
          ></i>
        </div>
      );
    });
      ...
      <Modal open={this.props.flag} onClose={this.props.close}>
        ...
        <div className='ask-modal-body'>
          <div>
            ...
            ></input>
            <span class='badge badge-light'>{this.state.length}</span>
          </div>
          <select className='question-text'>
          ...
          <button type='submit' className='submit-ask-question'>
            SUBMIT QUESTION{' '}
          </button>
        </div>
      </Modal>
